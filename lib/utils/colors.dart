...
//App static colors which can be used from any class.
class AppColors{
  static final Color textColor = const Color(0xFFccc7c5);
  static final Color mainColor = const Color(0xFF9BA3EB);
  ...
  static final Color redColor = const Color(0xFFC21010);
  static final Color greenColor = const Color(0xFF94B49F);
  static final Color whiteColor = const Color(0xFFE8F9FD);
